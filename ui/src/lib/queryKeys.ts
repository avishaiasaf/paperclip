export const queryKeys = {
  ...
  knowledge: {
    ...
    detail: (pageId: string) => ["knowledge", "detail", pageId] as const,
    revisions: (pageId: string) => ["knowledge", "revisions", pageId] as const,
    backlinks: (pageId: string) => ["knowledge", "backlinks", pageId] as const,
